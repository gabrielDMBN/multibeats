...
class ToxFinalizacao(pygame.sprite.Sprite):
    def __init__(self, posX, posY):
        super().__init__()
        self.frames = [
            pygame.image.load('graficos/FINALIZACOES/TOX/1f.png').convert_alpha(),
            pygame.image.load('graficos/FINALIZACOES/TOX/2f.png').convert_alpha(),
            pygame.image.load('graficos/FINALIZACOES/TOX/3f.png').convert_alpha(),
            pygame.image.load('graficos/FINALIZACOES/TOX/4f.png').convert_alpha(),
            pygame.image.load('graficos/FINALIZACOES/TOX/5f.png').convert_alpha(),
            pygame.image.load('graficos/FINALIZACOES/TOX/6f.png').convert_alpha(),
            pygame.image.load('graficos/FINALIZACOES/TOX/7f.png').convert_alpha(),
            pygame.image.load('graficos/FINALIZACOES/TOX/8f.png').convert_alpha(),
            pygame.image.load('graficos/FINALIZACOES/TOX/7f.png').convert_alpha(),
            pygame.image.load('graficos/FINALIZACOES/TOX/6f.png').convert_alpha(),
            pygame.image.load('graficos/FINALIZACOES/TOX/5f.png').convert_alpha(),
            pygame.image.load('graficos/FINALIZACOES/TOX/4f.png').convert_alpha(),
...
def init(game):  # ANIMADO
    # SONS
    pygame.mixer.stop()
    musica_fundo('sounds/TOX/toxbackground.ogg', 1)  # loop
    musica_rounds('sounds/Victory Sound.ogg', 0.08)  # som vitoria
    musica_rounds('sounds/TOX/toxfrase.ogg', 0.45)  # frase

    # ANIMADO
    game.moving_finalizacao = pygame.sprite.Group()
    game.fundo = ToxFinalizacao(0, 0)
